...
You can write about issues and errors in [issues](https://github.com/sigdev2/macroslib/issues) and end your fix as a [pull requests](https://github.com/sigdev2/macroslib/pulls)
